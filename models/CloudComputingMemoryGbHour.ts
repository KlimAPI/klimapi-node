...
export class CloudComputingMemoryGbHour {
    'type': CloudComputingMemoryGbHourTypeEnum;
    'activity'?: string;
    'specification'?: CloudComputingMemoryGbHourSpecificationEnum;
    /**
    *  **Hint:** Some specifications only support certain details.
    */
    'detail'?: CloudComputingMemoryGbHourDetailEnum;
    /**
    ...
    */
    'unit'?: CloudComputingMemoryGbHourUnitEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "CloudComputingMemoryGbHourSpecificationEnum",
            "format": ""
        },
        {
            "name": "detail",
            "baseName": "detail",
            "type": "CloudComputingMemoryGbHourDetailEnum",
            "format": ""
        },
        {
            "name": "value",
        ...
        },
        {
            "name": "unit",
            "baseName": "unit",
            "type": "CloudComputingMemoryGbHourUnitEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return CloudComputingMemoryGbHour.attributeTypeMap;
    }
...
export enum CloudComputingMemoryGbHourTypeEnum {
    CloudComputing = 'cloud_computing'
}
export enum CloudComputingMemoryGbHourSpecificationEnum {
    Aws = 'aws',
    Azure = 'azure',
    Gcp = 'gcp',
    Average = 'average'
}
export enum CloudComputingMemoryGbHourDetailEnum {
    AfSouth1 = 'af-south-1',
    ApEast1 = 'ap-east-1',
...
export enum CloudComputingMemoryGbHourUnitEnum {
    GbHour = 'gb-hour'
}
