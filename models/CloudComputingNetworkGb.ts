...
export class CloudComputingNetworkGb {
    'type': CloudComputingNetworkGbTypeEnum;
    'activity'?: string;
    'specification'?: CloudComputingNetworkGbSpecificationEnum;
    /**
    *  **Hint:** Some specifications only support certain details.
    */
    'detail'?: CloudComputingNetworkGbDetailEnum;
    /**
    ...
    */
    'unit'?: CloudComputingNetworkGbUnitEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "CloudComputingNetworkGbSpecificationEnum",
            "format": ""
        },
        {
            "name": "detail",
            "baseName": "detail",
            "type": "CloudComputingNetworkGbDetailEnum",
            "format": ""
        },
        {
            "name": "value",
        ...
        },
        {
            "name": "unit",
            "baseName": "unit",
            "type": "CloudComputingNetworkGbUnitEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return CloudComputingNetworkGb.attributeTypeMap;
    }
...
export enum CloudComputingNetworkGbTypeEnum {
    CloudComputing = 'cloud_computing'
}
export enum CloudComputingNetworkGbSpecificationEnum {
    Aws = 'aws',
    Azure = 'azure',
    Gcp = 'gcp',
    Average = 'average'
}
export enum CloudComputingNetworkGbDetailEnum {
    AfSouth1 = 'af-south-1',
    ApEast1 = 'ap-east-1',
...
export enum CloudComputingNetworkGbUnitEnum {
    Gb = 'gb'
}
