...
export class CloudComputingStorageTbHour {
    'type': CloudComputingStorageTbHourTypeEnum;
    'activity'?: string;
    'specification'?: CloudComputingStorageTbHourSpecificationEnum;
    /**
    *  **Hint:** Some specifications only support certain details.
    */
    'detail'?: CloudComputingStorageTbHourDetailEnum;
    /**
    ...
    */
    'unit'?: CloudComputingStorageTbHourUnitEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "CloudComputingStorageTbHourSpecificationEnum",
            "format": ""
        },
        {
            "name": "detail",
            "baseName": "detail",
            "type": "CloudComputingStorageTbHourDetailEnum",
            "format": ""
        },
        {
            "name": "value",
        ...
        },
        {
            "name": "unit",
            "baseName": "unit",
            "type": "CloudComputingStorageTbHourUnitEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return CloudComputingStorageTbHour.attributeTypeMap;
    }
...
export enum CloudComputingStorageTbHourTypeEnum {
    CloudComputing = 'cloud_computing'
}
export enum CloudComputingStorageTbHourSpecificationEnum {
    Aws = 'aws',
    Azure = 'azure',
    Gcp = 'gcp',
    Average = 'average'
}
export enum CloudComputingStorageTbHourDetailEnum {
    AfSouth1 = 'af-south-1',
    ApEast1 = 'ap-east-1',
...
export enum CloudComputingStorageTbHourUnitEnum {
    TbHour = 'tb-hour'
}
