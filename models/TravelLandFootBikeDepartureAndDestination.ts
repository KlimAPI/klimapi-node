...
export class TravelLandFootBikeDepartureAndDestination {
    'type': TravelLandFootBikeDepartureAndDestinationTypeEnum;
    'activity'?: string;
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return TravelLandFootBikeDepartureAndDestination.attributeTypeMap;
    }
...
export enum TravelLandFootBikeDepartureAndDestinationTypeEnum {
